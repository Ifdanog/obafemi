...
const Monologue = () => (
  <section
    ...
    className="py-24"
    style={{
      background: 'radial-gradient(ellipse 70% 60% at 80% 30%, rgba(201,168,76,0.06), transparent)',
    }}
  >
    <div className="max-w-6xl mx-auto px-6 md:px-8">
      ...
      <RevealBlock delay={130}>
        <p className="font-body text-mist text-lg max-w-2xl mb-3 leading-relaxed">
          Oniosun Obafemi is a lover of opportunities and a fast learner who believes his dexterity as an actor and screenwriter can take him to the next level in every facet of life. He is also keen on imparting the audience with a high level of positivity and hope.
        </p>
        <p className="font-body text-mist text-lg max-w-2xl mb-12 leading-relaxed">
          A versatile actor ready to collaborate and learn more — here are some of his monologues.
        </p>
      </RevealBlock>
