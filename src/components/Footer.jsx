...
const SOCIAL = [
  ...
  { href: 'https://x.com/king_tijesu',                icon: RiTwitterXLine, label: 'X / Twitter' },
  { href: 'https://facebook.com/obafemi.adebisi.73',  icon: FaFacebookF,    label: 'Facebook' },
  { href: 'https://instagram.com/oba_bisi',           icon: FaInstagram,    label: 'Instagram' },
  { href: 'mailto:obafemiadebisi19@gmail.com',        icon: AiOutlineMail,  label: 'Email' },
...
const Footer = () => (
  <footer
    ...
    style={{
      background: `
        radial-gradient(ellipse 80% 60% at 50% 100%, rgba(201,168,76,0.07), transparent),
    ...
    <div className="max-w-4xl mx-auto px-6 md:px-8">
      ...
      <RevealBlock delay={80}>
        ...
        ">
          ...
          <p className="font-mono text-[10px] tracking-[0.35em] uppercase text-gold mb-2">Get in Touch</p>
          <p className="font-body text-mist text-base mb-4">
            Available for acting roles, screenwriting collaborations, and dialogue directing.
          </p>
          <a
      ...
      <RevealBlock delay={120}>
        ...
        ">
          <p className="font-mono text-[9px] tracking-[0.2em] text-silver/40">
            © {new Date().getFullYear()} Oniosun Obafemi. All rights reserved.
          </p>
