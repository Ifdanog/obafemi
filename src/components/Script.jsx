...
const SCRIPTS = [
  {
    ...
    type: "drama",
    description:
      "A story about pressure, identity, and decision-making under fire. Two characters. One room. No escaping the truth.",
    pages: "12",
  },
  {
    path: "/ADDENDUM.pdf",
    ...
    type: "thriller",
    description:
      "A late-night discovery unravels a carefully constructed life. What gets added can never be removed.",
    pages: "9",
  },
  {
    ...
    type: "monologue",
    description:
      "An introspective piece exploring the voice one hears before every great risk—and the silence that follows.",
    pages: "3",
  },
  {
    ...
    type: "romance",
    description:
      "Three people, two choices, one turning point. A story about what love costs when it is shared.",
    pages: "28",
  },
  {
    ...
    type: "monologue",
    description:
      "A mother speaks for the first time about what she carried in silence. Tender, devastating, true.",
    pages: "4",
  },
  {
    ...
    type: "drama",
    description:
      "An internal landscape explored through restrained performance. Grief wears many faces—this one is quiet.",
    pages: "14",
  },
  {
    ...
    type: "drama",
    description:
      "Healing, memory, and what remains after trauma. A character study about the body and the stories it holds.",
    pages: "11",
  },
  {
    ...
    type: "drama",
    description:
      "What happens to boys who grow up without maps? A story about absence, improvisation, and becoming.",
    pages: "15",
  },
  {
    ...
    type: "monologue",
    description:
      "A confessional piece about childhood survival. Spoken directly to the audience with no apology.",
    pages: "5",
  },
  {
    path: "/IDOJUKOMI.pdf",
    ...
    type: "drama",
    description:
      "A Yoruba-infused narrative about confrontation — with the past, with family, and with self. An unflinching portrait.",
    pages: "32",
  },
];
...
const Script = () => {
  ...
  return (
    <section
      ...
      style={{
        background:
          "radial-gradient(ellipse 70% 60% at 20% 50%, rgba(26,95,106,0.07), transparent)",
      }}
    >
      <div className="max-w-6xl mx-auto px-6 md:px-8">
        ...
        <RevealBlock delay={140}>
          <p className="font-body text-mist text-lg max-w-2xl mb-10 leading-relaxed">
            From intimate monologues to feature-length narratives, each script
            represents a world built from language, rhythm, and the spaces
            between words.
          </p>
        </RevealBlock>
